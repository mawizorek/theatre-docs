...
one with the other and destroy the only thing that makes either useful, which
is being able to see where they disagree.

!!! warning "This is a dated snapshot"

    Every row is true as of the walk. A house this size re-patches constantly,
    so treat anything here as a strong lead rather than a fact, and verify
    before you cut power to something.
...
- [Circuits and dimmers](@oph-circuits), the schedule this was checked against
